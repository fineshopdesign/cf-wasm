...
export function sobel_global(a: number): void;
...
export function adjust_brightness(a: number, b: number): void;
export function inc_brightness(a: number, b: number): void;
export function dec_brightness(a: number, b: number): void;
...
export function __wbg_photonimage_free(a: number, b: number): void;
...
export function __wbg_rgba_free(a: number, b: number): void;
