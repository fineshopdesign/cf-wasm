...
export const apply_chromatic_aberration: (a: number, b: number, c: number) => void;
export const apply_lens_correction: (a: number, b: number, c: number) => void;
...
export const bayer_dither: (a: number, b: number, c: number) => void;
...
export const vignette: (a: number, b: number) => void;
...
export const apply_clarity: (a: number, b: number) => void;
export const apply_color_grading: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => void;
export const apply_dehaze: (a: number, b: number) => void;
export const apply_exposure: (a: number, b: number) => void;
export const apply_noise_reduction: (a: number, b: number, c: number, d: number) => void;
export const apply_noise_reduction_median: (a: number, b: number) => void;
export const apply_noise_reduction_nlm: (a: number, b: number, c: number, d: number) => void;
export const apply_noise_reduction_wavelets: (a: number, b: number, c: number) => void;
export const apply_sharpening: (a: number, b: number, c: number, d: number, e: number) => void;
export const apply_texture: (a: number, b: number) => void;
export const apply_tone_curve: (a: number, b: number, c: number) => void;
export const apply_tone_zones: (a: number, b: number, c: number, d: number, e: number) => void;
export const apply_vibrance: (a: number, b: number) => void;
export const apply_vignette: (a: number, b: number, c: number, d: number) => void;
export const apply_white_balance: (a: number, b: number, c: number) => void;
export const apply_noise_reduction_bilateral: (a: number, b: number, c: number, d: number) => void;
export const add_noise_rand: (a: number) => void;
export const cali: (a: number) => void;
export const cinematic: (a: number) => void;
...
export const film_grain: (a: number, b: number, c: number, d: number) => void;
