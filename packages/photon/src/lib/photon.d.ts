 ...
 * @param {number} blue
 */
export function gamma_correction(
 ...
 */
export function mix_with_colour(
	photon_image: PhotonImage,
	mix_colour: Rgb,
	opacity: number
): void;
 ...
 * @param {number} y
 */
export function draw_text_with_border(
 ...
 */
export function horizontal_strips(
	photon_image: PhotonImage,
	num_strips: number
): void;
/**
 ...
 * @param {Rgb} color
 */
export function color_horizontal_strips(
	photon_image: PhotonImage,
	num_strips: number,
	color: Rgb
): void;
 ...
 * @param {number} num_strips
 */
export function vertical_strips(
	photon_image: PhotonImage,
	num_strips: number
): void;
/**
 ...
 * @param {Rgb} color
 */
export function color_vertical_strips(
	photon_image: PhotonImage,
	num_strips: number,
	color: Rgb
): void;
 ...
 */
export function crop_img_browser(
 ...
 * @returns {HTMLCanvasElement}
 */
export function resize_img_browser(
	photon_img: PhotonImage,
	width: number,
	height: number,
 ...
 * @returns {PhotonImage}
 */
export function padding_uniform(
	img: PhotonImage,
	padding: number,
	padding_rgba: Rgba
): PhotonImage;
 ...
 * @returns {PhotonImage}
 */
export function padding_bottom(
	img: PhotonImage,
	padding: number,
	padding_rgba: Rgba
): PhotonImage;
 ...
 * @param {number} amt2
 */
export function alter_two_channels(
	img: PhotonImage,
	channel1: number,
	amt1: number,
	channel2: number,
 ...
 * @param {number} b_amt
 */
export function alter_channels(
	img: PhotonImage,
	r_amt: number,
	g_amt: number,
	b_amt: number
 ...
 */
export function remove_channel(
	img: PhotonImage,
	channel: number,
	min_filter: number
): void;
 ...
 * @param {number} degrees
 */
export function selective_hue_rotate(
	photon_image: PhotonImage,
	ref_color: Rgb,
	degrees: number
): void;
 ...
 * @param {number} amt
 */
export function selective_lighten(
	img: PhotonImage,
	ref_color: Rgb,
	amt: number
): void;
 ...
 * @param {number} amt
 */
export function selective_desaturate(
	img: PhotonImage,
	ref_color: Rgb,
	amt: number
): void;
 ...
 * @param {number} amt
 */
export function selective_saturate(
	img: PhotonImage,
	ref_color: Rgb,
	amt: number
): void;
 ...
 * @param {Rgb} ref_color
 */
export function selective_greyscale(
	photon_image: PhotonImage,
	ref_color: Rgb
): void;
/**
 ...
 */
export function grayscale_shades(
	photon_image: PhotonImage,
	num_shades: number
): void;
/**
 ...
 * @param {number} channel
 */
export function single_channel_grayscale(
	photon_image: PhotonImage,
	channel: number
): void;
/**
...
export interface InitOutput {
	...
	readonly draw_text_with_border: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly selective_color_convert: (
		a: number,
		b: number,
		c: number,
		d: number
	...
	readonly photonimage_get_bytes_jpeg: (
		a: number,
		b: number,
		c: number
	) => void;
